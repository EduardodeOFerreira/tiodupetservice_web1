			...
			<div id="area-menu">
				<div id="conteudo-menu">
					...
					<div id="area-principal">
						<div class="conteudo">
							<h2>
                			Ideal para quando você não quer deixar o seu pet sozinho durante o dia. Na nossa creche ele aproveita para se divertir muito com outros pets.
							</h2>

							<p>
                    		Creche para cachorro: cuidado e atenção o dia todo.
							</p>

							<p>
                    		Seu cão feliz o dia todo com nossa creche para cachorro.
							</p>

							<p>
                    		A creche para cachorro é o melhor lugar para fazer novos amigos. Até quem pensa que o cãozinho é antissocial se surpreende!
							</p>
						</div>
			    	</div>
			...
			<div class="conteudo">
				...
				<ul id="beneficios">
					<li>
							...
							<img src="assets/images/acomodacao (1).png" width="150" alt="acomodacao (1)">
